...
<form action="<?php echo e(route('seller.user.data.post')); ?>" method="post" class="ajaxForm">
    <?php echo csrf_field(); ?>
            ...
            <div class="row match-height">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12 text-center mb-3">
                                            <?php if($user->image && $user->image[0] && $user->image[0]->path): ?>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <?php echo $__env->make('components.sections.location', ['countries' => $countries, 'user' => $user], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <?php echo $__env->make('components.sections.crop', ['head'=> 'عکس پروفایل', 'type' => 'circle'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\shixeh\resources\views/seller/user/edite.blade.php ENDPATH**/ ?>