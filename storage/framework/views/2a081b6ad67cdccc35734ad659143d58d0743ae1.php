                      ...
                      <td class="p-1">
                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                          ...
                          data-original-title="Vinnie Mostowy" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-11.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
                          data-original-title="Elicia Rieske" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-7.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
                          data-original-title="Julee Rossignol" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-10.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
                          data-original-title="Darcey Nooner" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-8.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                        </ul>
                      </td>
                      ...
                      <td class="p-1">
                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                          ...
                          data-original-title="Trina Lynes" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-1.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
                          data-original-title="Lilian Nenez" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-2.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
                          data-original-title="Alberto Glotzbach" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-3.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                        </ul>
                      </td>
                      ...
                      <td class="p-1">
                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                          ...
                          data-original-title="Lai Lewandowski" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-6.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
                          data-original-title="Elicia Rieske" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-7.jpg')); ?>" alt="Avatar" height="30" width="30">
                          ...
                          data-original-title="Jeffrey Gerondale" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-9.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                        </ul>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="p-1">
                        <ul class="list-unstyled users-list m-0  d-flex align-items-center">
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
                          data-original-title="Vinnie Mostowy" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-5.jpg')); ?>" alt="Avatar" height="30" width="30">
                          </li>
                          <li data-toggle="tooltip" data-popup="tooltip-custom"  data-placement="bottom"
                          data-original-title="Elicia Rieske" class="avatar pull-up">
                            <img class="media-object rounded-circle" src="<?php echo e(asset('images/portrait/small/avatar-s-7.jpg')); ?>" alt="Avatar" height="30" width="30">
...
<?php echo $__env->make('layouts/contentLayoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\shixeh\resources\views//pages/dashboard-analytics.blade.php ENDPATH**/ ?>