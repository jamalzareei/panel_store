                ...
                <?php if(is_array($element)): ?>
                    <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($page == $paginator->currentPage()): ?>
                            <li class="paginate_button page-item active" aria-current="page"><span><?php echo e($page); ?></span></li>
                        <?php else: ?>
                            <li class="paginate_button page-item"><a href="<?php echo e($url); ?>"><?php echo e($page); ?></a></li>
                        <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\shixeh\resources\views/vendor/pagination/default.blade.php ENDPATH**/ ?>