                                            ...
                                            <div class="tab-content pt-1">
                                                <div class="tab-pane" id="file-fill" role="tabpanel" aria-labelledby="file-tab-fill">
                                                    <fieldset>
                                                        ...
                                                        <input type="file" name="image" class="dropify file-upload" data-default-file="<?php echo e(($tag) ? config('shixeh.cdn_domain_files').$tag->image : ''); ?>" />
                                                                    ...
                                                                    <li class="d-inline-block mr-2">
                                                                        <fieldset>
                                                                            <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                <input type="checkbox" name="actived_at" value="1" id="data-block" <?php echo e(($tag && $tag->actived_at) ? 'checked' : ''); ?>>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="عنوان صفحه" class="form-control" id="title" name="title" value="<?php echo e(($tag && $tag->seo) ? $tag->seo->title : ''); ?>">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="هدر h1 برای صفحه" class="form-control" id="head" name="head" value="<?php echo e(($tag && $tag->seo) ? $tag->seo->head : ''); ?>">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="متا تگ ها" data-role="tagsinput" class="form-control" id="meta_keywords" name="meta_keywords" value="<?php echo e(($tag && $tag->seo) ? $tag->seo->meta_keywords : ''); ?>">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea placeholder="متا توضیحات" id="meta_description" name="meta_description" rows="5" class="form-control"><?php echo e(($tag && $tag->seo) ? $tag->seo->meta_description : ''); ?></textarea>
