...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/leaflet.css" />
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" placeholder="latitude" class="form-control" id="latitude" name="latitude" value="<?php echo e($latitude ?? '31.87067197598904'); ?>">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" placeholder="Longitude" class="form-control" id="longitude" name="longitude" value="<?php echo e($longitude ?? '54.36171474738359'); ?>">
...
<script>
    var mapCenter = [ <?php echo e($latitude ?? '31.87067197598904'); ?>, <?php echo e($longitude ?? '54.36171474738359'); ?>];
