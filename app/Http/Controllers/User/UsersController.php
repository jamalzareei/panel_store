...
class UsersController extends Controller
{
    ...
    public function postUserData(Request $request)
    {
        ...
        $request->validate([
            ...
            'day' => 'nullable|required_with_all:month,year|integer|between:1,31',
            'month' => 'nullable|required_with_all:day,year|integer|between:1,12',
            'year' => 'nullable|required_with_all:month,day|integer|between:1300,1400',
