                                            ...
                                            <div class="tab-content pt-1">
                                                <div class="tab-pane active" id="file-fill" role="tabpanel" aria-labelledby="file-tab-fill">
                                                    <fieldset>
                                                        ...
                                                        <input type="file" name="image" class="dropify file-upload" data-default-file="{{($category) ? config('shixeh.cdn_domain').$category->image : ''}}" />
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="عنوان صفحه" class="form-control" id="title" name="title" value="{{ $category ? $category->title : ''}}">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="هدر h1 برای صفحه" class="form-control" id="head" name="head" value="{{ $category ? $category->head : ''}}">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" placeholder="متا تگ ها" data-role="tagsinput" class="form-control" id="meta_keywords" name="meta_keywords" value="{{ $category ? $category->meta_keywords : ''}}">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea placeholder="متا توضیحات" id="meta_description" name="meta_description" rows="5" class="form-control">{{ $category ? $category->meta_description : ''}}</textarea>
