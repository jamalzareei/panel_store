...
<style>
    ...
    .action-add-new{transform: translate(0, 20px); position: absolute;}
</style>
@endsection
...
@section('content')
    ...
    <section id="data-list-view" class="data-list-view-header">
        <div class="row d-flex" dir="ltr">
            ...
            <button type="button" class="btn bg-gradient-info mr-1 mb-1 waves-effect waves-light action-add-new" data-toggle="modal" data-target="#exampleModalCenter">
                        ...
                        @forelse ($categories as $key => $category)
                            <tr row="{{$category->id}}">
                                ...
                                <td col="order_by" class="" style="width: 10px">
                                    <input class="form-control-sm text-center p-0" type="number" name="order_by[{{$category->id}}]" id="" value="{{$category->order_by}}">
